FROM ubuntu:20.04
RUN apt-get -qq update -y && DEBIAN_FRONTEND="noninteractive" && apt-get -y upgrade && \
    apt-get -qq install -y software-properties-common apt-get install -y python3 python3-pip python3-lxml aria2
WORKDIR /usr/src/app
